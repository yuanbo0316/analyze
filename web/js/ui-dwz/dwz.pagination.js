                ...
                $this.find(setting.jumpto$).each(function() {
                    ...
                    $button.click(function(event) {
                        ...
                        if (pageNum && pageNum.isPositiveInteger()) {
                            var table = $(this).parents("div.panelBar:first").data("_table");       //取出表格对象
                            var json = table.data("_json");     //取出json
                            json.page = pageNum;                //设置页数
                            table.cutPage(json, table.data("_callback"));       //执行分页查询
                        }
                    });
