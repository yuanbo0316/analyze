...
import com.lianzt.jdbc.CutPageMysql;
...
public class CutPageServiceImpl extends BaseService {
    ...
    private final String[] KEYS = new String[]{"sql", "查询语句"};
    private final Logger log = LoggerFactory.getLogger(CutPageServiceImpl.class);
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead,
        ...
        if (pageSize == null) {
            pageSize = CutPageMysql.DEFAULT_PAGE_SIZE;
        }
        if (log.isDebugEnabled()) {
        ...
        LogUtil.analysisJsonLog("{\"sql\":\"" + in.getStringValue("sql") + "\", \"args\":\"" + StringUtil.connectArray(args, ",") + "\", \"database\":\"local\", \"_runTime\":" + sqlTime + "}", "cutpage-time");
        //构造响应数据
